...
public class ComponentImpl implements Component {
    ...
    public List<List<ImpactPathImpl>>  getImpactPaths() { return impactPaths; }
    @JsonProperty("impact_paths")
    public void setImpactPaths(List<List<ImpactPathImpl>> impactPaths) { this.impactPaths = impactPaths; }
}
